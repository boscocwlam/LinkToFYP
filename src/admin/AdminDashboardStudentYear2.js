...
const AdminDashboardStudentYear2 = () => {
  const organization_ID = localStorage.getItem("isOrganized");
  const year_ID = useParams().id;
  ...
  const [numberExperiencebyAllData, setNumberExperiencebyAllData] = useState(
    []
  ); // No. of Work Experience (All Years)
  ...
  useEffect(() => {
    // Total Students
    axios
      .post("http://localhost:3001/totalStudents2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/studentsHaveAJob2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    // cGPA (All Years)
    axios
      .post("http://localhost:3001/cGPAbyAllData2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/fypGradebyAllData2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/numberExperiencebyAllData2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/fypMostUsedSkills2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/workMostUsedSkills2", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
    ...
    axios
      .post("http://localhost:3001/getYearName", {
        organization_ID,
        year_ID,
      })
      .then((response) => {
        console.log(response.data);
        setYearName(response.data[0].year_name);
      });
  }, []);
  ...
  return (
    <div>
      ...
      <Container>
        <h2 className="title90">Dashboard - Students' Ability ({yearName})</h2>
      </Container>
...
export default AdminDashboardStudentYear2;
