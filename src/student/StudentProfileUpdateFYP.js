  ...
  const submitForm = (event) => {
    ...
    if( 
      ...
      ((fyp_skill_ID4 != null) && (fyp_skill_ID4 == fyp_skill_ID5))
        ...
        setUpdateStatus("");
        axios
        .post("http://localhost:3001/updatePersonalFYP", {
          user_ID,
          fyp_name,
          fyp_background,
          fyp_document,
    ...
    <div>
      ...
      <div>
        <Container>
          ...
          <h2 className="title90">Update Final Year Project</h2>
...
export default StudentProfileUpdateFYP;
