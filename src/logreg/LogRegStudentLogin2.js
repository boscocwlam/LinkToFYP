...
export default function LogRegStudentLogin2() {
  ...
  useEffect(() => {
    setUserName(localStorage.getItem("Email Address (Student)"));
    const email_address = localStorage.getItem("Email Address (Student)");
    axios
      .post("http://localhost:3001/checkStudentEmailExistLogIn", {
        email_address
      })
      .then((response) => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post("http://localhost:3001/getStudentLogin", {
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group text1">
            ...
            <div className="form-group text1">
                ...
                <input type="email" className="form-control" placeholder="Email Address"  value={username} name="email_address" readOnly required/>
            </div>
            <div className="mt-2"></div>
            <div className="form-group text1">
